    ...
    return (
        <>
            <div className="w-full min-h-[100px] flex items-center justify-center flex-col">
                <h1 className="font-geist text-[36px] font-bold text-[#1F2937] md:text-[54px] lg:text-[72px]">404 Not Found</h1>
                <h3 className="font-geist text-[36px] font-normal text-[#64748B] uppercase">This Page</h3>
