        ...
        <>
            <div className="w-full bg-white border border-[#E9E9E9] p-4 rounded-sm md:rounded-lg md:p-6">
                ...
                <div className="w-full grid grid-cols-1 gap-[14px] mt-[14px] md:gap-4 lg:grid-cols-3 lg:mt-4">
                    <button className="w-full py-[14px] bg-[#F8FAFC] border border-[#E9E9E9] rounded-sm flex items-center justify-center gap-2 flex-col text-[#1F2937] transition-colors duration-200 ease-linear hover:bg-[#244D3F] hover:border-[#244D3F] hover:text-white group cursor-pointer md:rounded-lg">
